export const metadata = {
  title: "CLI reference",
  description:
    "Every command-line flag of the kapkan binary — config path, log format and level, the pid file and nginx-style `-s` process control, the schema/validation utility flags, and the `dataplane status` command.",
};
